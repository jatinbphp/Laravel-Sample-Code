    ...
    <div class="row">
        <!-- <div class="input-field col s4 k-dropdown">
            ...
            <select name="admin_transfer_type" id="admin_transfer_type" class="paymentType browser-default">
                ...
                <option value="full" selected="selected"> {{trans('message.full')}}</option>
        ...
        <div class="input-field col s4 k-input-text">
            ...
            <input id="total_amout" name="total_amout" type="text" class="numeric validate k-txt-box" value="{{$amount}}" readonly="readonly">
        ...
        <div class="input-field col s4 k-dropdown">
            ...
            <select name="admin_payment_date" id="admin_payment_date" class="browser-default paymentUserfeedDay">
