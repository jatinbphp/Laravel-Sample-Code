    ...
    <div class="card-panel border-radius-6 card-with-header p-0 mt-0">
        <div class="groups-container">
            ...
            <div class="card-inner-continer">
                    ...
                    <div class="post-comments">
                        <div class="post-comment comment">
                            ...
                            <div class="comment-input">
                                <form id="form_new_user_feed" name="form_new_user_feed"
                                            ...
                                            <span class="ql-formats mr-0">
                                                ...
                                                <div class="post-files">
                                                    ...
                                                    <div class="file-field">
                                                     ...
                                                     <a href="#" class="add-post tooltipped btnUserFeed" data-id="{{$secretId}}" data-tooltip="{{trans('message.send')}} {{trans('message.newsfeed')}}">
                ...
                <div id="feed" class="newsFeed newsFeedResult userFeedResult">
                    @include("userfeed.filter",['userfeeds' => $userfeeds])
                </div>
            </div>
        </div>
    </div>
