<div class="table-block  table-block-new">
    <table class="striped highlight" id="userFeedSalaryLoan" style="width:100%">
        <thead>
            <tr>
                <th class="center">
                ...
                @foreach(getUserSalaryLoanFields() as $fieldId => $val)
...
<div id="modal-userfeed-salary-loan-request" class="modalx bottom-sheet hidden modal-custom modal-small">
    <div class="modal-header">
        <h4 class="k-h4 modalTitle">{{trans('message.add')}} {{trans('message.salary')}} {{trans('message.loan')}}</h4>
        <div class="buttons-group">
            <a href="#" class="close-userfeed-salary-loan-request"><img src="{{asset('img/icon-close.png')}}" alt=""></a>
        </div>
    </div>
