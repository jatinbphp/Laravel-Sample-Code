  ...
  <div class="row">
    <div class="input-field col s12">
      <div class="modal_button_center">
        @if(isset($salaryLoan))
          <button class="ml-4  btn k-button-fill k-btn  submit-edit-interview action-btn updateUserFeedSalaryLoan" name="action" type="submit" data-id="{{$salaryLoan->id}}">
            <img src="{{asset('img/edit.png')}}" alt="">
            {{trans('message.update')}} {{trans('message.salary')}} {{trans('message.loan')}}
          </button>
        @else
          <button class="action-btn  btn k-button-fill k-icon submitUserFeedSalaryLoan" type="submit">
